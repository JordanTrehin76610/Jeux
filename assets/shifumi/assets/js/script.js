...
function choix(jeu) {
    ...
    image.src = "../assets/shifumi/assets/img/mystere.png"
    choixadversaire()
    choixjoueur = jeu
    if (choixjoueur == 0) {
...
function revelation() {
    switch (adversaire) {
        case 0:
            image.src = "../assets/shifumi/assets/img/Pierre.png"
            break
        case 1:
            image.src = "../assets/shifumi/assets/img/Feuille.png"
            break
        case 2:
            image.src = "../assets/shifumi/assets/img/Ciseaux.png"
            break
        case 3:
            image.src = "../assets/shifumi/assets/img/puit.png"
            break
    }
    battle()
}
